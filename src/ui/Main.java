...
public class Main {
    public static void main(String[] args) {
        ...
        StudentManager manager = new StudentManager(user);

        user.setName(manager.fetchName(input));
        user.setStudentID(manager.fetchStudentID(input));
        user.setYearOfStudy(manager.fetchStudyYear(input));
        user.setSpecialization(manager.fetchSpecialization(input));
        ...
        ApplicationOverseer thisProgram = new ApplicationOverseer(manager);
